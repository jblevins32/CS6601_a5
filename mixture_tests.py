...
class K_means_test(unittest.TestCase):
    ...
    def test_k_means(self, k_means_cluster):
        ...
        # initial mean for each k value͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏︀͏󠄋͏︊͏󠄏
        initial_means = [
            np.array([[0.90980393, 0.8392157, 0.65098041],
                      [0.83137256, 0.80784315, 0.69411767]]),
            np.array([[0.90980393, 0.8392157, 0.65098041],
        ...
        # test different k values to find best͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏︀͏󠄋͏︊͏󠄏
...
class GMMTests(unittest.TestCase):
    ...
    def test_gmm_prob(self, prob):
        ...
        # Single Input͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏︀͏󠄋͏︊͏󠄏
        ...
        # Multiple Input͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏︀͏󠄋͏︊͏󠄏
    ...
    def test_gmm_likelihood(self, likelihood):
        ...
        # expected_lkl =͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏︀͏󠄋͏︊͏󠄏
        print_success_message()
    ...
    def test_gmm_train(self, train_model, likelihood):
        ...
        likelihood_thresh = 280000
        diff_check = likelihood_difference >= likelihood_thresh
        #To verify if there is an increase in the likelihood values͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏︀͏󠄋͏︊͏󠄏
        self.assertTrue(diff_check, msg=("Model likelihood increased by less"
                                         " than %d for a two-mean mixture, possibly the training is not increasing the likelihood: Please print the values of likelihood in the loop to verify" % likelihood_thresh))
        print_success_message()
    ...
    def test_gmm_best_segment(self, best_segment):
        ...
        num_components = 3
        iters = 10
        # generate best segment from 10 iterations͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏︀͏󠄋͏︊͏󠄏
        # and extract its likelihood͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏︀͏󠄋͏︊͏󠄏
        best_likelihood, best_seg = best_segment(image_matrix, num_components, iters)

        ref_likelihood = 35000
        # # compare best likelihood and reference likelihood͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏︀͏󠄋͏︊͏󠄏
    ...
    def test_gmm_improvement(self, improved_initialization, initialize_parameters, train_model, likelihood):
        ...
        # first train original model with fixed means͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏︀͏󠄋͏︊͏󠄏
        ...
        # # then train improved model͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏︀͏󠄋͏︊͏󠄏
        ...
        # # then calculate likelihood difference͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏︀͏󠄋͏︊͏󠄏
        diff_thresh = 3e3
    ...
    def test_convergence_condition(self, improved_initialization, train_model_improved, initialize_parameters,
        ...
        # # test convergence difference͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏︀͏󠄋͏︊͏󠄏
